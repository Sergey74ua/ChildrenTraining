...
/*
 *ДЗ_5: Рекурсивная функция dfs принимает координаты, проверяет их на принадлежность карте
 *		и закрытость, после чего окрывает ячейку, перенося значение из массива минного поля.
 *		Затем, двойной цикл обходит соседние ячейки, проверяя исключением самой центральной
 *		ячейки и прерывается запуская рекурсию с передачей координат соседней пустой ячейки.
 *		Таким образом, постепенно открывая все соприкасающиеся пустые ячейки и вновь проверяя
 *		их окружение, так как return вернет выполнение в точку вызова функции.
